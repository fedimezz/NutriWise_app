...
<head>
    ...
    <title>Ajouter un Suivi - NutriWise Admin</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div class="form-container" style="margin-top: 2rem;">
                <?php if(isset($error)): ?><p style="color:red; margin-bottom:15px; font-weight:bold;"><?= htmlspecialchars($error) ?></p><?php endif; ?>
                <form action="index.php?page=admin_add_suivi" method="POST">
                    <div class="form-group">
                        <label>Utilisateur</label>
                        <select name="user_id" required>
                            <option value="">-- Sélectionner --</option>
                            <?php foreach($users as $u): ?>
                                <option value="<?= $u['id'] ?>"><?= htmlspecialchars($u['prenom'].' '.$u['nom']) ?> (<?= htmlspecialchars($u['email']) ?>)</option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="calories_necessaires" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="etat" required>
                            ...
                            <option value="S'affine (Perd du poids)">S'affine (Perd du poids)</option>
                            <option value="Grandit (Gagne du poids)">Grandit (Gagne du poids)</option>
                        </select>
                    </div>

                    <div style="display: flex; gap: 1rem;">
                        <button type="submit" class="btn-primary">Ajouter le suivi</button>
