...
<nav class="navbar">
    ...
    <div class="nav-links">
        ...
        <?php if($isLoggedIn): ?>
            ...
            <a href="index.php?page=consultations" class="nav-link <?php echo $currentPage == 'consultations' ? 'active' : ''; ?>">Consultations</a>
            <a href="index.php?page=historique_activites" class="nav-link <?php echo $currentPage == 'historique_activites' ? 'active' : ''; ?>">Historique</a>
            <a href="index.php?page=notifications" class="nav-link <?php echo $currentPage == 'notifications' ? 'active' : ''; ?>">Notifications</a>
        <?php else: ?>
            ...
            <a href="#" class="nav-link disabled" style="opacity:0.5; cursor:not-allowed;" onclick="return false;">Consultations</a>
            <a href="#" class="nav-link disabled" style="opacity:0.5; cursor:not-allowed;" onclick="return false;">Historique</a>
            <a href="#" class="nav-link disabled" style="opacity:0.5; cursor:not-allowed;" onclick="return false;">Notifications</a>
        <?php endif; ?>
